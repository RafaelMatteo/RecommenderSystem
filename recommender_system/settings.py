"""
Django settings for recommender_system project. - Django 5.1.1.
"""
...
SECRET_KEY = 'django-insecure-p+%76kn1uw7%-n$#e0z=4*4!9%w0!wpf#$*ol3bq4x+nd%ud@0'
